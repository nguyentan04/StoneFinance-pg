...
const configurations: { [env: string]: Configuration } = {
  ...
  //     'APEX-FTM-LP': ['0x13Fe199F19c8F719652985488F150762A5E9c3A8', 18],
  //     'ASHARE-FTM-LP': ['0x20bc90bB41228cb9ab412036F80CE4Ef0cAf1BD5', 18],
  //   },
  ...
  development: {
    ...
    externalTokens: {
      ...
      'APEX-FTM-LP': ['0x78e7743bA9b517fe4737DAa64687900790793D26', 18],
      'ASHARE-FTM-LP': ['0x7Ff074fdc6F5831538902516CCCAD0ae63c8914b', 18],
    },
    baseLaunchDate: new Date('2021-06-02 13:00:00Z'),
    bondLaunchesAt: new Date('2020-12-03T15:00:00Z'),
    masonryLaunchesAt: new Date('2020-12-11T00:00:00Z'),
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  AshareFtmLPAShareRewardPool: {
    ...
    depositTokenName: 'ASHARE-FTM-LP',
    earnTokenName: 'ASHARE',
    finished: false,
    sort: 7,
    closedForStaking: false,
